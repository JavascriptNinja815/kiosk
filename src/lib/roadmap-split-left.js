let content = `
  <style>
    ...
    .visible {
      animation: spring-in var(--animation-length) 1;
      animation-fill-mode: forwards;
    }
    
    .hiding {
      animation: spring-out var(--animation-length) 1;
      animation-fill-mode: forwards;
    }
...
//      transition: transform 0.5s ease;
  ...
  <div class="circle">
    ...
    <div class="content">
      <img class="logo" src="sprites/logo-main-49.png" alt="">
      <slot></slot>
    </div>
  </div>
  <img class="cabinet" src="sprites/split-49.png" alt="">
`;

class RoadmapSplitLeft extends HTMLElement {
  constructor() {
    super();
...
customElements.define('roadmap-split-left', RoadmapSplitLeft);
